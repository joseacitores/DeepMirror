...
# -*- coding: utf-8 -*-
"""
Created on Thu Dec 22 23:33:07 2022
...
smilestoken = deepchem.feat.SmilesTokenizer()
...
smiles_train_val = smilestoken.get_default_tokenizer().tokenize(train_val.iloc[:, 1].to_list())
smiles_test_val = smilestoken.get_default_tokenizer().tokenize(test.iloc[:, 1].to_list())
